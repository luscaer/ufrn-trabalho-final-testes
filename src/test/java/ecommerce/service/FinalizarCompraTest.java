...
public class FinalizarCompraTest {
    ...
    void calcularCustoTotal_quandoCarrinhoNulo_entaoLancaExcecao() {
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> service.calcularCustoTotal(null));
    ...
    void calcularCustoTotal_quandoCarrinhoSemDescontos_entaoRetornaSomaSimples() {
        ...
        BigDecimal total = service.calcularCustoTotal(carrinho);
    ...
    void calcularCustoTotal_quandoRegiaoNordeste_entaoMultiplicaFretePor110() {
        ...
        BigDecimal totalNordeste = service.calcularCustoTotal(carrinho);
        BigDecimal totalSudeste = service.calcularCustoTotal(carrinho);
